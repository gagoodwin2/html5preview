...
lib.ssMetadata = [
		{name:"4in10_492x328_sc_atlas_1", frames: [[0,0,1040,240],[1042,0,829,296],[538,443,920,53],[0,242,536,143],[538,298,536,143],[0,387,536,143],[1076,298,536,143]]}
];
...
(lib.CachedBmp_6 = function() {
	this.initialize(ss["4in10_492x328_sc_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},79).to({state:[]},10).to({state:[{t:this.instance_1}]},10).to({state:[{t:this.instance_2}]},1).to({state:[]},9).wait(66));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/4in10_492x328_sc_atlas_1.png", id:"4in10_492x328_sc_atlas_1"}
	],
	preloads: []
};
