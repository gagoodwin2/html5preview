...
lib.ssMetadata = [
		{name:"over60_728x90_en_atlas_1", frames: [[675,225,186,42],[0,145,380,180],[0,0,1007,143],[382,145,291,78],[675,145,291,78],[382,225,291,78],[675,269,291,9]]}
];
...
(lib.CachedBmp_17 = function() {
	this.initialize(ss["over60_728x90_en_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(103.5,84.9541,1,1.1506);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(0,66,207,38), null);
...
if (reversed == null) { reversed = false; }
	...
	mask.setTransform(46.475,10.45);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},99).to({state:[]},10).to({state:[{t:this.instance_2}]},10).to({state:[]},10).wait(46));

	// wp6
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(101.375,49.975);
	...
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(86.825,49.975);
...
p.nominalBounds = new cjs.Rectangle(364,45,346.79999999999995,45);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/over60_728x90_en_atlas_1.png", id:"over60_728x90_en_atlas_1"}
	],
	preloads: []
};
