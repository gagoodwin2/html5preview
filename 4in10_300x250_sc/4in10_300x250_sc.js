...
lib.ssMetadata = [
		{name:"4in10_300x250_sc_atlas_1", frames: [[602,399,378,85],[0,243,600,180],[879,99,20,85],[0,0,508,241],[510,99,367,98],[602,199,367,98],[602,299,367,98],[510,0,462,97]]}
];
...
(lib.CachedBmp_8 = function() {
	this.initialize(ss["4in10_300x250_sc_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_7.setTransform(23.45,110.45,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/4in10_300x250_sc_atlas_1.png", id:"4in10_300x250_sc_atlas_1"}
	],
	preloads: []
};
