...
lib.ssMetadata = [
		{name:"4in10_728x90_en_atlas_1", frames: [[675,226,186,42],[0,146,380,180],[0,0,1007,144],[382,146,291,78],[675,146,291,78],[382,226,291,78],[675,270,291,9]]}
];
...
(lib.CachedBmp_7 = function() {
	this.initialize(ss["4in10_728x90_en_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(103.5,83.7473,1,1.121);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(0,65.3,207,37), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_6.setTransform(206.95,11,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/4in10_728x90_en_atlas_1.png", id:"4in10_728x90_en_atlas_1"}
	],
	preloads: []
};
