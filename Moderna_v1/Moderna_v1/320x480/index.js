...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1E2946").s().p("");
	this.shape.setTransform(51.775,34.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#1E2946").s().p("");
	this.shape_1.setTransform(0.125,34.4393);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#1E2946").s().p("");
	this.shape_2.setTransform(-52.425,34.775);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#1E2946").s().p("");
	this.shape_3.setTransform(-104.3,34.675);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#1E2946").s().p("Ag4A3QAfgKARgRQANgPACgRIgFAAQgTAAgNgLQgPgNAAgVQAAgVAPgMQAOgMATAAQAaAAAPASQANAUAAAfQAAAqgaAgQgaAggtAOg");
	this.shape_4.setTransform(88.825,-8.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#1E2946").s().p("");
	this.shape_5.setTransform(52.175,-25.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#1E2946").s().p("");
	this.shape_6.setTransform(1.4,-25.325);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#1E2946").s().p("");
	this.shape_7.setTransform(-51.425,-25.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#1E2946").s().p("");
	this.shape_8.setTransform(-104.425,-23.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.s4_mc, new cjs.Rectangle(-128,-48.9,222.6,107.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.1,scaleY:1.1},449).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {frame2:27,frame3:62,frame4:97,frame5:132,frame6:167,frame7:202};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);

	this.actionFrames = [0,26,61,96,131,166,201,239];
	// timeline functions:
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(26).call(this.frame_26).wait(35).call(this.frame_61).wait(35).call(this.frame_96).wait(35).call(this.frame_131).wait(35).call(this.frame_166).wait(35).call(this.frame_201).wait(38).call(this.frame_239).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(186).to({_off:false},0).to({y:79.5,alpha:1},15,cjs.Ease.quadOut).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(151).to({_off:false},0).to({y:79.5,alpha:1},15,cjs.Ease.quadOut).to({y:39.5,alpha:0},15,cjs.Ease.quadInOut).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(116).to({_off:false},0).to({y:79.5,alpha:1},15,cjs.Ease.quadOut).to({y:39.5,alpha:0},15,cjs.Ease.quadInOut).wait(94));

	// s3
	this.instance_7 = new lib.s3_mc();
	this.instance_7.setTransform(151.5,129.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(81).to({_off:false},0).to({y:79.5,alpha:1},15,cjs.Ease.quadOut).to({y:39.5,alpha:0},15,cjs.Ease.quadInOut).wait(129));

	// s2
	this.instance_8 = new lib.s2_mc();
	this.instance_8.setTransform(143.75,165.5);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(46).to({_off:false},0).to({y:115.5,alpha:1},15,cjs.Ease.quadOut).to({y:75.5,alpha:0},15,cjs.Ease.quadInOut).wait(164));

	// s1
	this.instance_9 = new lib.s1_mc();
	this.instance_9.setTransform(143,155.35);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(12).to({_off:false},0).to({y:95.35,alpha:1},14,cjs.Ease.quadOut).to({y:55.35,alpha:0},15,cjs.Ease.quadInOut).wait(199));
	...
	this.instance_11.setTransform(249.5,513.45);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({y:453.45},14,cjs.Ease.quadInOut).wait(226));

	// brand
	this.instance_12 = new lib.white_bg();
	this.instance_12.setTransform(160,526.55);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({y:466.55},14,cjs.Ease.quadInOut).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.kv_mc).wait(240));
