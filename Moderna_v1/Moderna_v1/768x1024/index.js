...
}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(-101.1,-23.6,240.2,54), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.1,scaleY:1.1,x:-26.6,y:-36.2},449).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance_11.setTransform(599.5,1083.45);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({y:963.45},14,cjs.Ease.quadInOut).wait(226));

	// brand
	this.instance_12 = new lib.white_bg();
	this.instance_12.setTransform(382.45,1114.45,2.1889,2.1882,0,0,0,-0.2,-1);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({y:994.45},14,cjs.Ease.quadInOut).wait(226));
...
p.nominalBounds = new cjs.Rectangle(372.8,502.1,405.3,702.1);
// library properties:
lib.properties = {
