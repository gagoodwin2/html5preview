...
lib.ssMetadata = [
		{name:"over60_320x480_sc_atlas_1", frames: [[642,774,220,49],[0,0,580,942],[0,944,640,320],[582,0,517,352],[582,354,517,138],[582,494,517,138],[582,634,517,138]]}
];
...
(lib.CachedBmp_7 = function() {
	this.initialize(ss["over60_320x480_sc_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(30.85,186.8,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/over60_320x480_sc_atlas_1.png", id:"over60_320x480_sc_atlas_1"}
	],
	preloads: []
};
